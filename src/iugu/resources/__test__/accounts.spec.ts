...
test('should verify account', async () => {
  const apiKey = process.env.SUBACCOUNT_TEST_API_KEY || 'E54892F5EC916E8889EEDE7274DB0922C3103AB07735A2361DC7C740234DF865'
...
test('should configure account', async () => {
  ...
  expect(response.id).toBe('34AE95C87EFE453BB7F1F756098BFD35')
